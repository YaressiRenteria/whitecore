              ...
              <div className="p-10 flex flex-col">
                ...
                <button
                  onClick={() => {
                    ...
                    const message =
                      `Hola White Core 👋%0A%0A` +
                      `Quiero comprar:%0A` +
                      `${selectedProduct.name}%0A` +
                      `Cantidad: ${quantity}%0A` +
                      `Total: $${total}%0A%0A` +
                      `¿Me pueden dar información de entrega?`;
                  ...
                  className="mt-8 bg-blue-600 hover:bg-blue-700 text-white py-5 rounded-2xl font-black text-lg flex items-center justify-center gap-3 transition shadow-lg shadow-blue-600/20"
                >
